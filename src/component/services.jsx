  ...
  return (
    <section className="bg-white py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Tab Navigation */}
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-12 border-b border-gray-200 overflow-x-auto">
          {Object.keys(techCategories).map((category) => (
            <button
              key={category}
              onClick={() => setActiveTab(category)}
              className={`pb-4 px-2 text-sm md:text-lg font-medium transition-colors duration-200 whitespace-nowrap ${
                activeTab === category
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 ">
          {techCategories[activeTab]?.map((tech, index) => (
            ...
            >
              ...
              <h3
                className={`text-center font-semibold text-sm md:text-base ${tech.color} group-hover:text-gray-900 transition-colors duration-200`}
              >
                {tech.name}
              </h3>
            </div>
...
const OptimizedITServices = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section id="home" className="pt-20 md:pt-24 bg-gray-100">
        <div className="container mx-auto px-4 py-8 md:py-16">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="text-black space-y-6 md:space-y-8">
              ...
              <div className="pt-4">
                <button className="px-6 py-3 bg-red-700 hover:bg-red-800 text-white font-semibold transition-all rounded-md">
                  Contact Us
                </button>
              </div>
            </div>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-sm md:text-base text-gray-600 mb-6 md:mb-8 italic">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="bg-gray-50 p-4 md:p-6 rounded-xl hover:shadow-md transition-all duration-300 border-t-4 border-red-600"
                >
                  <div className="flex items-start gap-3 md:gap-4">
                    <div className="bg-red-100 text-red-600 font-bold text-base md:text-lg px-3 py-2 md:px-4 rounded-full flex-shrink-0">
                      {feature.number}
                    </div>
                    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {services.map((service) => {
              ...
              return (
                <div
                  key={service.id}
                  className="group relative overflow-hidden rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 p-6 md:p-8 hover:bg-white/15 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25"
                >
                  ...
                  {/* Icon */}
                  <div
                    className={`relative z-10 w-12 h-12 md:w-16 md:h-16 rounded-xl bg-gradient-to-br ${service.gradient} p-2 md:p-3 mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
                  ...
                  <div className="relative z-10">
                    <h3 className="text-lg md:text-xl font-bold text-white mb-3 md:mb-4 group-hover:text-purple-200 transition-colors duration-300">
                      {service.title}
                    </h3>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-gray-800 p-6 md:p-8 rounded-xl hover:-translate-y-2 transition-transform duration-300"
              >
                ...
                <p className="text-sm md:text-base text-gray-300 mb-6 italic">
                  "{testimonial.content}"
                </p>
                <div className="flex items-center">
                  <div className="bg-red-600 rounded-full w-10 h-10 md:w-12 md:h-12 flex items-center justify-center text-white font-bold mr-4 text-sm md:text-base">
