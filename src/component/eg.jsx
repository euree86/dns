...
import { Monitor, Building2, Smartphone, Check } from "lucide-react";
import Nav from "./nav";
      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product, index) => (
            <div
              key={index}
              className="bg-gray-50  flex flex-col gap-2 relative shadow-md hover:shadow-lg transition duration-300 
          hover:-translate-y-1"
            >
